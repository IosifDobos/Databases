...
INSERT INTO Book (bookid, title, authorID) VALUES (120, 'Catcher in the Rye', 107); 
INSERT INTO Book (bookid, title, authorID) VALUES (133, 'Cloud Atlas'); 
...
INSERT INTO Borrower (BorrowerID, Last_name, First_name ,Street_address,Zip ) VALUES  (103, 
 ...
 INSERT INTO Borrower (BorrowerID, Last_name, First_name ,Street_address,Zip ) VALUES
 	 (103,    'Sheppard', 'Sam', '70 Oaks Avenue', 'Mytown, MA 01234'); 
...
INSERT INTO Transaction  (TransactionID, BorrowerID,  BookID, Transaction_date, Transaction_Type)
  VALUES (100, 107, 104, SYSDATE, 1); 
  commit;
  
-- Select statements
SELECT  Last_name, First_name, Street_address  FROM  Borrower;
SELECT * FROM Borrower;
-- Select all the transactions
SELECT * from Transaction;
-- 
SELECT TransactionID, Borrowerid FROM Transaction WHERE Transaction_date
-- projection
